...
source_refs: ["06_SOURCE/Code/engine/pipeline/reaction_engine.py#L174", "06_SOURCE/Code/engine/pipeline/reaction_engine.py#L646", "06_SOURCE/Code/engine/pipeline/reaction_engine.py#L1376"]
related_entities: ["test.source_validation", "test.direction_tests"]
source_reference: ["06_SOURCE/Code/engine/pipeline/reaction_engine.py#L174", "06_SOURCE/Code/engine/pipeline/reaction_engine.py#L646", "06_SOURCE/Code/engine/pipeline/reaction_engine.py#L1376"]
---
...
- **Purpose:** Detect canonical directional Reaction formations and confirmations.
- **Inputs:** RAW-derived candle chronology, First/context roles, directional box and strict crossings.
- **Calculation logic:** The source-grounded rule and its exact ordering are stated above.
- **Output:** Reaction, Reset and confirmation provenance for dependent stages.
