...
Eligible historical E rescues are appended after lifecycle, StopAll, and Internal ownership is fixed; they must not feed back into calculation, family/number, S/A visibility, or Order provenance. Only at the end clip to presentation main indexes.
...
- **Output:** Final visible collections and serializable public result.
