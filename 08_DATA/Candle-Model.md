...
At the 2026-09-26 inventory confirmation, the seven retained physical RAW arrays had strictly increasing timestamps and no duplicate exact seconds at inspection; three additional registered inputs are logical windows reconstructed from their retained parents. This observed property is not a universal parser guarantee. The bridge's bucket construction and duplicate-second handling are retained in the captured bridge source, while the chart RAW store's captured source covers write validation.
