...
Snapshot confirmation: 2026-09-26. The current Vault contains seven retained physical RAW arrays and five physical metadata sidecars. Three exact logical windows are reproducible from retained parent arrays, so the historical inventory has ten byte identities but not ten physical RAW files. No superseded smaller RAW or sidecar is retained or pending deletion. Each physical JSON array was checked for five-key rows, increasing positive integer epochs, OHLC bounds and nominal timestamp alignment; each logical window is checked by deterministic reconstruction. The captured byte hashes are in the dataset and window notes; this inventory does not depend on a production directory.
...
| [data.dataset_f531a06d](../Datasets/Dataset-f531a06d.md) | 621,326 | 1788449740 | 1789501784 | 28,387 | 176,481 | none |
| [data.dataset_ea82be1a](../Datasets/Dataset-ea82be1a.md) | 354,698 | 1787617410 | 1790173875 | 991 | 176,485 | matched |
| [data.dataset_f5bc29e3](../Datasets/Dataset-f5bc29e3.md) | 309,906 | 1787617410 | 1789765170 | 821 | 176,485 | none |
